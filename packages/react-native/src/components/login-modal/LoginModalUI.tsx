...
const AUTH_STATE_MESSAGES: Record<AuthState['step'], string> = {
  ...
  signing_wallet_challenge: 'Signing wallet challenge…',
  creating_passkey: 'Creating passkey…',
  deploying_smart_account: 'Deploying account…',
              ...
              <View style={styles.socialList}>
                {enabledSocial.some(([key]) => key === 'google') && (
                  <TouchableOpacity
                    ...
                    onPress={() => onSocialLogin && onSocialLogin('google')}
                    disabled={isLoading}
                  >
                ...
                {enabledSocial.some(([key]) => key === 'github') && (
                  <TouchableOpacity
                    style={[styles.socialBtn, { borderColor: colors.border }]}
                    onPress={() => onSocialLogin && onSocialLogin('github')}
                    disabled={isLoading}
                  >
